...
(function (factory) {
        ...
        readFiles: function (files) {
            ...
            readFile = function (i) {
                ...
                if ($preview.length && FileReader !== undefined) {
                    ...
                    $status.html(msgLoading.replace('{portal}', i + 1).replace('{files}', numFiles));
                    $container.addClass('file-thumb-loading');
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgLoading: 'Loading file {portal} of {files} &hellip;',
        msgProgress: 'Loading file {portal} of {files} - {name} - {percent}% completed.',
